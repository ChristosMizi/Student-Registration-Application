...
namespace StudentRegistrationSystem {
    ...
    public partial class RegisteredUsersDataSet : global::System.Data.DataSet {
        ...
        public partial class tblUsersDataTable : global::System.Data.TypedTableBase<tblUsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public tblUsersRow FindByEmail(string Email) {
...
namespace StudentRegistrationSystem.RegisteredUsersDataSetTableAdapters {
    ...
    public partial class tblUsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblUsers] WHERE (([UserId] = @Original_UserId) AND ([Email] = @Original_Email) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Roles = 1 AND [Roles] IS NULL) OR ([Roles] = @Original_Roles)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblUsers] ([Email], [Password], [Roles], [Description]) VALUES" +
                ...
                "es, Description FROM tblUsers WHERE (Email = @Email)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblUsers] SET [Email] = @Email, [Password] = @Password, [Roles] = @Roles, [Description] = @Description WHERE (([UserId] = @Original_UserId) AND ([Email] = @Original_Email) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Roles = 1 AND [Roles] IS NULL) OR ([Roles] = @Original_Roles)));
SELECT UserId, Email, Password, Roles, Description FROM tblUsers WHERE (Email = @Email)";
        ...
        public virtual int Fill(RegisteredUsersDataSet.tblUsersDataTable dataTable) {
        ...
        public virtual RegisteredUsersDataSet.tblUsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RegisteredUsersDataSet.tblUsersDataTable dataTable = new RegisteredUsersDataSet.tblUsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RegisteredUsersDataSet.tblUsersDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Roles, string Description, int Original_UserId, string Original_Email, string Original_Password, string Original_Roles) {
            return this.Update(Original_Email, Password, Roles, Description, Original_UserId, Original_Email, Original_Password, Original_Roles);
        }
    }
